...
int main() {
    auto player{note_player_print{}};
    rtttl_play(player, let_it_be);
   ...
   // }      
   // 
   // if constexpr( 0 ){ rtttl_play( p, sos ); }   
   // if constexpr( 0 ){ rtttl_play( p, let_it_be );  }
   // if constexpr( 0 ){ rtttl_play( p, muppets );  }
   // if constexpr( 0 ){ rtttl_play( p, rickroll );  }
   // if constexpr( 1 ){ rtttl_play( p, one );  }
}
